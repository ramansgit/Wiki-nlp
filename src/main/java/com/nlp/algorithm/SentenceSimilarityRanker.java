...
/**
 * Ranks an article line by similarity to a given question Uses n-gram for
 * phrase matching and Bitap approximate matching of each n-gram
 */
public class SentenceSimilarityRanker {
	 ...
	 * 
	 * @param text
	 *            Preprocessed article sentence to searc
	 * @param pattern
	 *            Preprocessed question to search
	 * @return return match score of the question. Integer.MIN_VALUE if no match
	 *         found
	 */
	...
	/**
	 * "Dumb" matcher when two sentences are ranked equally. Tries to do full
	 * text searches and assigns an rank appropriately
	 * 
	 * @param text
	 *            to search for
	 * @param pattern
